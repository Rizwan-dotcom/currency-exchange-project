...
export const Sidebar = () => {
  return (
    <aside className=" hidden lg:block fixed overflow-y-auto top-50 left-4 w-[280px] h-[95vh] rounded-lg shadow-md mt-5">
      ...
      <nav>
        ...
        <li className="pt-8 pb-3 text-gray-600">
              <a href="#" className="flex justify-between items-center px-8">
        ...
        <footer className="bg-gray-200 rounded-2xl mx-4 my-4 pt-3 ">
